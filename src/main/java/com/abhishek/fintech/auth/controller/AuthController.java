package com.abhishek.fintech.auth.controller;
...
public class AuthController {
    ...
    @Operation(summary = "Register a new user", description = "Creates a new user account with BCrypt password encryption and returns an active JWT Bearer token.")
    @ApiResponses(value = {
    ...
    @PostMapping("/login")
    @Operation(summary = "Authenticate user", description = "Authenticates user credentials and returns a valid JWT Bearer token.")
    @ApiResponses(value = {
